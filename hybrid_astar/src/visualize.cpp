...
void Visualize::publishMainRoad()
 {
    ...
    geometry_msgs::Point32 rightup;
    geometry_msgs::Point32 leftup;
    geometry_msgs::Point32 midup;
    geometry_msgs::Point32 rightdown;
    geometry_msgs::Point32 leftdown;
    geometry_msgs::Point32 middown;

    float roadwidth = 20;


    rightup.x =-98.200086876670696;
    rightup.y = 162.726126993589872;
    midup.x = -24.433196326913524;
    midup.y = 182.727835534465584;
    leftup.x = 65.202874040277294;
    leftup.y = 191.874589853983139;
    leftdown.x =59.986262647813689;
    leftdown.y = 208.838013400553763;
    middown.x = 0.915529605119181;
    middown.y = 201.021718340743234;
    rightdown.x = -85.983488714737078;
    rightdown.y =180.388118035097875;


    mainRoad.polygon.points.push_back(rightup);
    mainRoad.polygon.points.push_back(midup);
    mainRoad.polygon.points.push_back(leftup);
    mainRoad.polygon.points.push_back(leftdown);
    mainRoad.polygon.points.push_back(middown);
    mainRoad.polygon.points.push_back(rightdown);
