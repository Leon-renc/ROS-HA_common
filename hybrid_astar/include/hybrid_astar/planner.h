...
*/
  ...
  */
        void setStart(const geometry_msgs::PoseStamped::ConstPtr &initial);
  ...
  */
        ...
        void setALPout(const std_msgs::Bool   ALP_command);
        bool  getALPout(){ return ALPOut; }        
        void plan();
    ...
    private:
       ...
       /// The lastgoal to test voiding same planning road
        ...
        tf::Quaternion tf_clockwise_rot_;
